...
public class MainActivity extends BaseActivity   implements ConversionListeners {
    ...
    private void init(){
        ...
        binding.converationsRecyclerView.setAdapter(conversationAdapter);
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error) -> {
        ...
        if (value != null) {
            ...
            binding.converationsRecyclerView.smoothScrollToPosition(0);
            binding.converationsRecyclerView.setVisibility(View.VISIBLE);
